...
for ind in range(1, 10):
	annot_filename = f'{config.IMAGE_CAT}_annotation_{str(ind).zfill(4)}.mat'
	img_filename = f'{config.IMAGE_CAT}_image_{str(ind).zfill(4)}.jpg'
